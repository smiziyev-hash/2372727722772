...
export const RouterHead = component$(() => {
  ...
  return (
    <>
      {/* Basics */}
      <title>{head.title || 'InkSec - The ultimate personal security checklist to secure your digital life'}</title>
      ...
      <meta property="og:title" content="InkSec - The ultimate personal security checklist to secure your digital life" />
      ...
      <meta name="twitter:title" content="InkSec - The ultimate personal security checklist to secure your digital life" />
